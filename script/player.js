...
class Audio_Player {
    constructor() {
      ...
      this.play_pause();
        ...
        this.names_radio =[];
        this.names_radio[0]="RADIO Q.M.C";
        this.names_radio[1]="RADIO ROLL SKY";
        this.names_radio[2]="RADIO BBC";
        this.names_radio[3]="RADIO MSN";

        this.source_audio =[];
        this.source_audio[0]= "music1.mp3";
        this.source_audio[1]= "music2.mp3";
        this.source_audio[2]= "music3.mp3";
        this.source_audio[3]= "music4.mp3";
        this.server = 0;
